...
# Eval
parser.add_argument(
    "--data_path_eval", type=str, help="path to the data for evaluation", required=False
)
parser.add_argument(
    "--gt_path_eval",
    type=str,
...
def main_worker(args):
    # CRF model
    model = PixelFormer(
        version=args.encoder, inv_depth=False, max_depth=args.max_depth, pretrained=None
    )
    model.train()
